...
@interface RSAutoWebView ()<UIWebViewDelegate, WKNavigationDelegate, WKUIDelegate, RS_NJKWebViewProgressDelegate>
...
@property (nonatomic, strong) RSUWWebViewProgress* webViewProgress;

@end

@implementation RSAutoWebView
...
- (void)initUIWebView {
    ...
    self.webViewProgress = [[RSUWWebViewProgress alloc] init];
